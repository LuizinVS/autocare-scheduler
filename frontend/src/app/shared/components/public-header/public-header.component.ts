...
@Component({
  ...
  template: `
    <header class="flex-none bg-black px-4 sm:px-6 lg:px-10">
      <div class="flex w-full items-center justify-between px-6 py-4 sm:px-10 sm:py-5 lg:px-20">
        ...
        <a routerLink="/login" class="rounded-lg border border-white/40 px-5 py-2 text-sm font-semibold transition hover:border-white hover:bg-white hover:text-black">Entrar</a>
      </div>
    </header>
  `
})
